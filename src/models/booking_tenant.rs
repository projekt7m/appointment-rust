...
pub struct BookingTenant {
    ...
    pub reservation_limit_mode: crate::models::ReservationLimit,
...
impl BookingTenant {
    pub fn new(tenant_id: String, timezone: String, reservation_limit_mode: crate::models::ReservationLimit, address: String, phone: String, fax: String, email: String, email_signature: String, name: String, email_internal: String, calendar_extra_info: String, required_conditions: Vec<String>) -> BookingTenant {
        BookingTenant {
            tenant_id,
            timezone,
