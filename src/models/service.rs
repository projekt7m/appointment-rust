...
impl Service {
    pub fn new(service_id: uuid::Uuid, tenant_id: uuid::Uuid, name: String, expenditure_minutes: i32, default_tags: Vec<uuid::Uuid>, questions: Vec<models::ExtraQuestion>) -> Service {
        Service {
            service_id,
            tenant_id,
            name,
