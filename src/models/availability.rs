...
impl Availability {
    pub fn new(availability_id: String, tenant_id: String, worker_id: String, day_of_week: crate::models::DayOfWeek, start_time: String, end_time: String, services: Vec<String>) -> Availability {
        Availability {
            availability_id,
            tenant_id,
            worker_id,
