...
impl Availability {
    pub fn new(availability_id: uuid::Uuid, tenant_id: uuid::Uuid, worker_id: uuid::Uuid, day_of_week: models::DayOfWeek, start_time: String, end_time: String, services: Vec<uuid::Uuid>) -> Availability {
        Availability {
            availability_id,
            tenant_id,
            worker_id,
