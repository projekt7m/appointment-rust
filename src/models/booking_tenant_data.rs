...
pub struct BookingTenantData {
    #[serde(rename = "data")]
    pub data: Vec<crate::models::BookingTenant>,
}

impl BookingTenantData {
    pub fn new(data: Vec<crate::models::BookingTenant>) -> BookingTenantData {
        BookingTenantData {
            data,
        }
    }
