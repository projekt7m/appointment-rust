...
pub struct ListWrapperWorkerDataInner {
...
impl ListWrapperWorkerDataInner {
    pub fn new(worker_id: uuid::Uuid, tenant_id: uuid::Uuid, name: String, services: Vec<uuid::Uuid>, default_tags: Vec<uuid::Uuid>) -> ListWrapperWorkerDataInner {
        ListWrapperWorkerDataInner {
            worker_id,
            tenant_id,
            name,
            description: None,
