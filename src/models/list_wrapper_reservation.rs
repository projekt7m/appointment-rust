...
pub struct ListWrapperReservation {
    #[serde(rename = "data")]
    pub data: Vec<models::ListWrapperReservationDataInner>,
}

impl ListWrapperReservation {
    pub fn new(data: Vec<models::ListWrapperReservationDataInner>) -> ListWrapperReservation {
