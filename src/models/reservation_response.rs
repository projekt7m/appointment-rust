...
pub struct ReservationResponse {
    #[serde(rename = "reservation_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub reservation_id: Option<Option<uuid::Uuid>>,
    #[serde(rename = "success")]
    pub success: bool,
    #[serde(rename = "retry_other_time", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub retry_other_time: Option<Option<bool>>,
    #[serde(rename = "medium", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub medium: Option<Option<models::Medium>>,
}
