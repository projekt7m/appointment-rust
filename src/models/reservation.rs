...
impl Reservation {
    pub fn new(reservation_id: String, tenant_id: String, worker_id: String, _type: Type, start_time: String, end_time: String, description: String, confirmation_sent: bool, reminder_sent: bool, client_notified: bool, tags: Vec<String>, answers: String, answer_shorthands: String, source: Source) -> Reservation {
        Reservation {
            reservation_id,
            tenant_id,
            worker_id,
