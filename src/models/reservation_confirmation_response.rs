...
pub struct ReservationConfirmationResponse {
...
impl ReservationConfirmationResponse {
    pub fn new(reservation_id: String, tenant_id: String, success: bool) -> ReservationConfirmationResponse {
