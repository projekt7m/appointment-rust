...
impl ReservationRequest {
    pub fn new(tenant_id: uuid::Uuid, service_id: uuid::Uuid, worker_id: uuid::Uuid, firstname: String, lastname: String, email: String, time: String, phone_number: String, answers: String, answer_shorthands: String) -> ReservationRequest {
        ReservationRequest {
            tenant_id,
            service_id,
            worker_id,
