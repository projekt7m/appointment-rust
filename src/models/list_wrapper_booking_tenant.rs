...
pub struct ListWrapperBookingTenant {
    #[serde(rename = "data")]
    pub data: Vec<models::ListWrapperBookingTenantDataInner>,
}

impl ListWrapperBookingTenant {
    pub fn new(data: Vec<models::ListWrapperBookingTenantDataInner>) -> ListWrapperBookingTenant {
        ListWrapperBookingTenant {
            data,
        }
    }
}
