...
pub struct ListWrapperAvailability {
    #[serde(rename = "data")]
    pub data: Vec<models::ListWrapperAvailabilityDataInner>,
}

impl ListWrapperAvailability {
    pub fn new(data: Vec<models::ListWrapperAvailabilityDataInner>) -> ListWrapperAvailability {
        ListWrapperAvailability {
            data,
        }
    }
}
