...
pub struct ListWrapperHoliday {
    #[serde(rename = "data")]
    pub data: Vec<models::ListWrapperHolidayDataInner>,
}

impl ListWrapperHoliday {
    pub fn new(data: Vec<models::ListWrapperHolidayDataInner>) -> ListWrapperHoliday {
        ListWrapperHoliday {
            data,
        }
    }
