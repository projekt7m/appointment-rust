...
pub struct ListWrapperHolidayRegion {
    #[serde(rename = "data")]
    pub data: Vec<models::ListWrapperHolidayRegionDataInner>,
}

impl ListWrapperHolidayRegion {
    pub fn new(data: Vec<models::ListWrapperHolidayRegionDataInner>) -> ListWrapperHolidayRegion {
