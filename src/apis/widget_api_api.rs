...
pub async fn get_booking_config(configuration: &configuration::Configuration, id: &str) -> Result<models::TenantConfig, Error<GetBookingConfigError>> {
...
pub async fn get_booking_schedule(configuration: &configuration::Configuration, tid: &str, sid: &str, wid: &str, date: String) -> Result<models::Availabilities, Error<GetBookingScheduleError>> {
    let local_var_configuration = configuration;
...
pub async fn post_booking_reserve(configuration: &configuration::Configuration, reservation_request: models::ReservationRequest) -> Result<models::ReservationResponse, Error<PostBookingReserveError>> {
    let local_var_configuration = configuration;
...
pub async fn post_booking_reserve_confirmation(configuration: &configuration::Configuration, rid: &str, confirmation_request: models::ConfirmationRequest) -> Result<models::ConfirmationResponse, Error<PostBookingReserveConfirmationError>> {
    let local_var_configuration = configuration;
...
pub async fn put_booking_reserve_by_id(configuration: &configuration::Configuration, rid: &str, reservation_request: models::ReservationRequest) -> Result<models::ReservationResponse, Error<PutBookingReserveByIdError>> {
    let local_var_configuration = configuration;
