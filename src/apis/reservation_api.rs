...
pub async fn get_reservations(configuration: &configuration::Configuration, start_time_min: Option<String>, start_time_max: Option<String>, tag_id: Option<&str>) -> Result<models::ListWrapperReservation, Error<GetReservationsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_reservations_by_id(configuration: &configuration::Configuration, id: &str) -> Result<models::Reservation, Error<GetReservationsByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn post_reservations(configuration: &configuration::Configuration, new_reservation: models::NewReservation) -> Result<models::Reservation, Error<PostReservationsError>> {
    let local_var_configuration = configuration;
...
pub async fn put_reservation_by_id(configuration: &configuration::Configuration, id: &str, reservation: models::Reservation) -> Result<models::Reservation, Error<PutReservationByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn put_reservation_tags_by_id(configuration: &configuration::Configuration, id: &str, uuid_colon_colon_uuid: Vec<uuid::Uuid>) -> Result<models::Reservation, Error<PutReservationTagsByIdError>> {
    let local_var_configuration = configuration;
