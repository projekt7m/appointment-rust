...
> models::TenantConfig get_booking_config(id)
Get the basic configuration information for the widget of the specified tenant

It is the entry point for the widget. The widget only needs to know in the page of which tenant it is used, then it sends out a request to this endpoint to know its basic configuration, services and workers it can offer to the user.
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **uuid::Uuid** | ID in UUID format of the tenant to get the configuration for | [required] |

### Return type

[**models::TenantConfig**](TenantConfig.md)
...
> models::Availabilities get_booking_schedule(tid, sid, wid, date)
Get the available times at which a service can be booked.

After the user has selected a service and a worker, the Widget will use this endpoint to request the time slots it can provide to the user. Time slots are requested by date.
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**tid** | **uuid::Uuid** | ID of the tenant to get the timestamps for | [required] |
**sid** | **uuid::Uuid** | ID of the service to get timestamps for | [required] |
**wid** | **uuid::Uuid** | ID of the worker to get timestamps for | [required] |
...
[**models::Availabilities**](Availabilities.md)
...
> models::ReservationResponse post_booking_reserve(reservation_request)
...
[**models::ReservationResponse**](ReservationResponse.md)
...
> models::ConfirmationResponse post_booking_reserve_confirmation(rid, confirmation_request)
Confirm a reservation with the PIN sent to the user

After the user has entered the PIN he received in the Widget, the widget has to send the PIN to the server using this function. On the one hand this will confirm the reservation to the server, and on the other hand will tell the widget whether the entered PIN has been correct.
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**rid** | **uuid::Uuid** | ID of the reservation that gets confirmed | [required] |
**confirmation_request** | [**ConfirmationRequest**](ConfirmationRequest.md) | The PIN the user entered | [required] |

### Return type

[**models::ConfirmationResponse**](ConfirmationResponse.md)
...
> models::ReservationResponse put_booking_reserve_by_id(rid, reservation_request)
Resend the code for an existing reservation

TODO: Use this endpoint also to allow updating a revervation
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**rid** | **uuid::Uuid** | ID of the reservation that gets updated | [required] |
